    ...
    return (
        <ListGroupItem>
            ...
            <div className="float-right">
                <Link to={{ pathname: '/edit', state: { item } }} className="btn btn-secondary btn-sm">Edit</Link>
        &nbsp;
        <Button color="danger" size="sm" onClick={onDelete} data-id={item._id}> Delete </Button>
            </div>
        </ListGroupItem>
    )
}